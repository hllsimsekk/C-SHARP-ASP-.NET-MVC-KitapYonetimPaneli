...
(function (factory) {
    ...
    DataTable.util = {
        ...
        get: function (source) {
            if ($.isPlainObject(source)) {
                ...
                // Array or flat object mapping
                return function (data, type, row, meta) { // row and meta also passed, but not used
                        ...
                        if (_order != null) {
                            ...
                            switch (_order.type) {
                                ...
                                case "button":
                                    ...
                                    switch (_order.buttons) {
                                        case "d":
                                            _order.link = "<i class='glyphicon ays-icon icon-detay' title:'Detay/Düzenle'></i>";
                                            break;
                                        case "s":
                                            _order.link = "<i class='glyphicon ays-icon icon-sil' title:'Sil'></i>";
                                            break;
    ...
    function _fnColumnOptions(oSettings, iCol, oOptions) {
        ...
        oCol.fnGetData = function (rowData, type, meta) {
            var innerData = mData(rowData, type, undefined, oCol, oSettings);
